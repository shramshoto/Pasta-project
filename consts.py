...
FONT_NAME = "Calibri"
MESSAGE_A =f'ומסתמכים עליהם ללכוד את השמן ולחבר בינו לבין השאר.\nכוללים בתוכם גורם מחבר (מתחלב) כמו יין, ביצה, לימון או חומץ\nטבעי – כמו שמן ומים. רטבים אמולסיביים כמו אליו אה אוליו, פסטו וקרבונרה לרוב\nאמולסיה {'(Emulsion)'[::-1]} היא תערובת יציבה בין שני נוזלים שאינם מתערבבים באופן'[::-1]
MESSAGE_B =f' חשוב לשמור עליו בזמן הבישול אחרת הרוטב לא יידבק וישחה בצלחת אחרי שכבר סיימתם לאכול\n לרוטב העגבניות הוא העמילן שעל פני הפסטה וגם במים בהם בישלו אותה.\n לרוטב העגבניות הוא העמילן שעל פני הפסטה וגם במים בהם בישלו אותה.\n לדוגמה - הרוטב שלנו, רוטב עגבניות.\n ומה שמספק את מקומות העיגון האלו, הוא ייפרד אלא אם כן פני הפסטה יספקו מספיק מקומות עיגון.\nאם הרוטב מכיל מעל {'18 %'[::-1]}שמן *ללא* מתחלבים \n'[::-1]
